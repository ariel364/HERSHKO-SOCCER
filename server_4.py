...
def process_video(input_path, output_path):
    ...
    camera_movment_per_frame = camera_movment_estimator.get_camera_movment(video_frames, read_from_stub=False, stub_path='stubs/camera_movment_stub.pkl')
...
def handle_client(client):
    try:
        ...
        client.sendall(f"http://localhost:8000/video/{os.path.basename(output_path)}".encode())
